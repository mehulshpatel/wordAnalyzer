...
import org.springframework.boot.actuate.autoconfigure.endpoint.web.jersey._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(ManagementContextConfiguration.class, () -> _FactoryProvider.jerseyWebEndpointManagementContextConfiguration());
